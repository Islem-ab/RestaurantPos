...
export const defaultMenus: MenuItem[] = [
  { id: 1, name: "Pizza",     price: 15, image: require("../../assets/images/pizza.png"),    category: "plats" },
  { id: 2, name: "Tacos",     price: 12, image: require("../../assets/images/tacos.png"),    category: "plats" },
  { id: 3, name: "Burger",    price: 10, image: require("../../assets/images/burger.png"),   category: "sandwichs" },
  { id: 4, name: "Sandwitch", price: 8,  image: require("../../assets/images/sandwich.png"), category: "sandwichs" },
  { id: 5, name: "Pasta",     price: 14, image: require("../../assets/images/pasta.png"),    category: "pates" },
  { id: 6, name: "Salad",     price: 9,  image: require("../../assets/images/salad.png"),    category: "salades" },
];
